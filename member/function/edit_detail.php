...
if (isset ($_SESSION['username']) && $_SESSION['level'] == 2 && ($_SESSION['security_code'])) 
{
    ...
    $qry = mysqli_query($conn,"SELECT * FROM chitietxuathang where MaMatHang = '$id' and MaPhieuXuat = '$id_ex'"); 
    ...
    if(isset($_POST['Update'])) 
    {
        ...
        $query = "UPDATE chitietxuathang SET  SoLuong = '$SL', DonGia = '$single_price', ThanhTien = '$total_price'
        WHERE MaPhieuXuat = '$exportID' AND MaMatHang = '$idgoods' ";
        $run = mysqli_query($conn,$query);
        if ($run)
        {
            ?>
                <script>
                    if (!alert('Update item export success!')) {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="margin: auto; width: 50%;">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sửa chi tiết mặt hàng trong thiếu thu</h1>
                    <br>

                    
                    <div class="card shadow mb-4" style="width: 50rem;">
                        <div class="card-header py-3">
                          <h4>Sửa phần số lượng mặt hàng tính giá</h4>  
                        </div>
                        <div class="card-body">
                        <form method="POST">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <input type="text" value= "<?php echo $data0['MaMatHang'] ?>" name="idgoods" class="form-control" placeholder="Nhập mã mặt hàng" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" value= "<?php echo $data0['SoLuong'] ?>" name="SL" class="form-control" placeholder="Nhập số lượng" required>
                            </div>
                            <div class="modal-footer">
                                <a href="../DeliveryDetail.php?ID=<?php echo $id_ex?>" class="btn btn-secondary active" role="button" aria-pressed="true">Huỷ</a>
