...
$id = $_GET['ID']; 
$qry = mysqli_query($conn,"SELECT * FROM phieuxuathang where MaPhieuXuat ='$id'"); 
...
if (isset ($_SESSION['username']) && $_SESSION['level'] == 1 && ($_SESSION['security_code'])) 
{
    if(isset($_POST['Update'])) 
    {
        ...
        $date = $_POST['date']; 
            $sql="UPDATE phieuxuathang SET MaDaiLy ='$idstore',
            NgayLapPhieu ='$date' WHERE MaPhieuXuat = '$id'";
            ...
            if ($result) 
            {
                ?>
                <script>
                    if (!alert('Edit Export Note success!')) {
                ...
                <div class="container-fluid" style="margin: auto; width: 50%;">
                    ...
                    <div class="card shadow mb-4" style="width: 50rem;">
                        ...
                        <div class="form-group">
                                <input type="text" value="<?php echo $data0['MaPhieuXuat'] ?>" name="exportID" class="form-control" placeholder="Nhập mã phiếu xuất" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <div class="dates">
                                    <input type="text" value="<?php echo $data0['NgayLapPhieu'] ?>" name="date" id="date" class="form-control" placeholder="YYYY-MM-DD" autocomplete="off"  required>
                                </div> 
                            </div>
                            <div class="modal-footer">
                                <a href="../DeliveryNote.php" class="btn btn-secondary active" role="button" aria-pressed="true">Huỷ</a>
