...
$id = $_GET['ID']; 
$qry = mysqli_query($conn,"SELECT * FROM mathang where MaMatHang ='$id'"); 
...
if (isset ($_SESSION['username']) && $_SESSION['level'] == 1 &&($_SESSION['security_code'])) 
{
    if(isset($_POST['Update'])) 
    {
        $name = $_POST['name'];
        $price = $_POST['price']; 
            $sql="UPDATE mathang SET TenMatHang ='$name',
            DonGia ='$price' WHERE MaMatHang = '$id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="margin: auto; width: 50%;">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Danh sách các mặt hàng</h1>
                    <br>
                    ...
                    <div class="card shadow mb-4" style="width: 50rem;">
                        ...
                        <label class="col-sm-2 col-form-label">Mã mặt hàng</label>
                        <div class="col-sm-10">
                        <input type="text" name="idgoods" value="<?php echo $data['MaMatHang'] ?>" class="form-control" placeholder="Nhập mã đại lý" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Tên mặt hàng</label>
                        <div class="col-sm-10">
                        <input type="text" name="name" value="<?php echo $data['TenMatHang'] ?>" class="form-control" placeholder="Nhập mã đại lý" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Đơn giá</label>
                        <div class="col-sm-10">
                        <input type="text" name="price" value="<?php echo $data['DonGia'] ?>" class="form-control" placeholder="Nhập mã đại lý" required>
                        </div>
                      </div>
                        <div class="form-group row">
                        <div class="col-sm-10">
                          <button type="submit" name="Update" class="btn btn-primary">Sửa</button>
                          <a href="../addgoods.php" class="btn btn-secondary active" role="button" aria-pressed="true">Huỷ</a>
                        </div>
                      </div>
                          </form>
                        </div>
