...
if (isset ($_SESSION['username']) && $_SESSION['level'] == 1 && ($_SESSION['security_code'])) 
{
    if(isset($_POST['Update'])) 
    {
        ...
        {
        $level = $_POST['level']; 
            $sql="UPDATE login SET  username = '$username', level ='$level' WHERE ID = '$id'";
            ...
            if ($result) 
            {
                ?>
                <script>
                    if (!alert('Edit level account success!')) {
                        document.location = "../usermanger.php";
                    }
                </script>
                <?php
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="margin: auto; width: 50%;">
                    ...
                    <div class="card shadow mb-4" style="width: 50rem;">
                        ...
                        <div class="col-sm-10">
                        <input type="text" name="username" value="<?php echo $data['username'] ?>" class="form-control" placeholder="Nhập mã đại lý" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-10">
                          ...
                          <a href="../usermanger.php" class="btn btn-secondary active" role="button" aria-pressed="true">Huỷ</a>
                        </div>
                      </div>                                          
                          </form>
                        </div>
